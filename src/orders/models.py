...
class CustomerOrder(ModelProperties):
    ...
    car = models.ForeignKey(Cars, on_delete=models.CASCADE, related_name='car_customer_order')
...
class DealerOrder(ModelProperties):
    ...
    car = models.ForeignKey(Cars, on_delete=models.CASCADE, related_name='car_dealer_order')
